...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.print(Arrays.stream(arr1).map(Object::toString).collect(Collectors.joining(" ")));
    System.out.print(" ");
    System.out.print(Arrays.stream(arr2).map(Object::toString).collect(Collectors.joining(" ")));
  }
